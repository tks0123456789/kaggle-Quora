...
python exp_bert_base.py --exp_name "multi_cased_12" --exp_num 21 --n_folds 5 --fold 0 --seed_split 4567 --train_batch_size 64 --gradient_accumulation_steps 8 --num_train_epochs 2 --n_models 3 --n_bertlayers 8 --max_seq_length 50 --bert_model "bert-base-multilingual-cased" --do_lower_case 0

python exp_bert_base.py --exp_name "multi_cased_12" --exp_num 22 --n_folds 5 --fold 0 --seed_split 4567 --train_batch_size 64 --gradient_accumulation_steps 8 --num_train_epochs 2 --n_models 3 --n_bertlayers 8 --max_seq_length 50 --bert_model "bert-base-multilingual-cased" --do_lower_case 1
